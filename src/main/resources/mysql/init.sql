...
CREATE TABLE IF NOT EXISTS jilin_user(
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS jilin_item(
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
  service VARCHAR(255) DEFAULT NULL,
  item TEXT DEFAULT NULL
) DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS jilin_relation (
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS jilin_linkuser (
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS jilin_order (
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
  uuid varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS jilin_price(
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS jilin_patent(
  ID INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
